  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="process/logoutprocess.php?logout=<?php echo $_SESSION['id']?>" style="text-decoration:none;color:#FFF;"type="button" class="button-red" id="btnLogin"><i class="fa fa-sign-in"></i> Logout</a>
      </div>
    </div>
  </div>
</div>